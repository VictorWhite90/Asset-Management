...
// Components (kept eager - small, used on every route)
...
const RegisterMinistryAdminPage = lazy(() => import('@/pages/RegisterMinistryAdminPage'));
const MinistryAdminDashboardPage = lazy(() => import('@/pages/MinistryAdminDashboardPage'));
...
const AgencyAssetsPage = lazy(() => import('@/pages/AgencyAssetsPage'));
const AgencyReportsPage = lazy(() => import('@/pages/AgencyReportsPage'));
const AssetDetailsPage = lazy(() => import('@/pages/AssetDetailsPage'));
const EditAssetPage = lazy(() => import('@/pages/EditAssetPage'));
const ReviewUploadsPage = lazy(() => import('@/pages/ReviewUploadsPage'));
const ViewUploadsPage = lazy(() => import('@/pages/ViewUploadsPage'));
const AdminAssetsPage = lazy(() => import('@/pages/AdminAssetsPage'));
const AdminMinistryAdminVerificationsPage = lazy(() => import('@/pages/AdminMinistryAdminVerificationsPage'));
const AdminMinistriesPage = lazy(() => import('@/pages/AdminMinistriesPage'));
