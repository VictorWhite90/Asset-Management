    ...
    >
      ...
      >
        <Container maxWidth="lg">
          ...
          >
            <Lock sx={{ fontSize: 12 }} />
            OFFICIAL • {deploymentLabels.securePortalOwner} • AUTHORIZED ACCESS ONLY
            <Lock sx={{ fontSize: 12 }} />
          </Typography>
        </Container>
      </Box>
      ...
      <Container maxWidth="lg" sx={{ flex: 1, display: 'flex', flexDirection: 'column', justifyContent: 'center', py: 6, position: 'relative', zIndex: 5 }}>
        ...
        <Box sx={{ textAlign: 'center', mb: 6 }}>
          ...
          >
            {isStateDeployment ? deploymentLabels.topAdminOffice : 'Federal Ministry of Finance, Budget & National Planning'}
          </Typography>
          ...
          >
            ...
            of government assets across all {isStateDeployment ? 'state' : 'federal'} ministries, departments, and agencies.
        ...
        <Grid container spacing={3} sx={{ mb: 6 }}>
          {[
            ...
            { icon: <AdminPanelSettings sx={{ fontSize: 32 }} />, title: 'Ministry Integration', desc: `Seamless coordination between all ${isStateDeployment ? 'state' : 'federal'} ministries` },
