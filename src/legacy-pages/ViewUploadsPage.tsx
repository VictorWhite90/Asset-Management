...
const ViewUploadsPage: React.FC = () => {
  ...
  const fetchAssets = useCallback(async () => {
    ...
    try {
      ...
      } else if (isApprover && userData?.ministryId && userData?.state) {
        // Approvers see only assets from their assigned state within their ministry
  ...
  }, [isUploader, isApprover, userData?.userId, userData?.ministryId, userData?.state]);
