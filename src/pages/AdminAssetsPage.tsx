...
const AdminAssetsPage = () => {
  ...
  const loadDetailedAssets = async () => {
    ...
    try {
      ...
      // Federal admin should only see assets submitted to federal level or already processed
  ...
  const getStatusLabel = (status: AssetStatus): string => {
    switch (status) {
      ...
      case 'submitted_to_federal': return 'Submitted to Federal';
  ...
  const getStatusColor = (status: AssetStatus): 'success' | 'warning' | 'error' | 'info' => {
    switch (status) {
      ...
      case 'pending_ministry_review': return 'info';
                ...
                <CardContent>
                  <Box sx={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
                    <Box>
                      ...
                      <Typography variant="h4" sx={{ color: '#FFFFFF', fontWeight: 700 }}>
                        {dashboardStats.statusCounts.submitted_to_federal}
                      </Typography>
                ...
                <CardContent>
                  <Box sx={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
                    <Box>
                      ...
                      <Typography variant="h5" sx={{ color: '#FFFFFF', fontWeight: 700 }}>
                        {formatCurrency(dashboardStats.totalMarketValue)}
                      </Typography>
                    </Box>
          ...
          <Grid container spacing={2} alignItems="center">
            ...
            <Grid item xs={12} sm={6} md={2}>
              ...
              >
                ...
                <MenuItem value="submitted_to_federal">Awaiting Review</MenuItem>
