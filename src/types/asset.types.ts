...
export interface Asset {
  ...
  // Federal submission (Ministry Admin sends to Federal Admin)
  submittedToFederalBy?: string; // userId of ministry admin who submitted
  submittedToFederalAt?: Timestamp; // When submitted to federal
