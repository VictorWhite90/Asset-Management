...
export const deploymentLabels = {
  ...
  sentToTopAdmin: isStateDeployment ? 'Sent to State Chairman' : 'Sent to Federal',
  submittedToTopAdmin: isStateDeployment ? 'Submitted to State Ministry' : 'Submitted to Federal',
