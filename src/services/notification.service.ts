    ...
    case 'asset.approved':
      return {
        ...
        htmlBody: `
          ...
          <p>Hello ${recipient.name},</p>
          <p>Your asset upload has been reviewed and approved by <strong>${data.approverName}</strong>.</p>
          ...
          <p>The asset has been sent to your Ministry Admin for review and will be forwarded to the Federal Administrator.</p>
...
Your asset upload has been reviewed and approved by ${data.approverName}.
...
The asset has been sent to your Ministry Admin for review and will be forwarded to the Federal Administrator.
